...
export class PersonServiceProxy {
     ...
     * @return Success
     */
    getPeople(filter: string | undefined): Observable<PersonListDtoListResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PersonListDtoListResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PersonListDtoListResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetPeople(response: HttpResponseBase): Observable<PersonListDtoListResultDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PersonListDtoListResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PersonListDtoListResultDto>(<any>null);
    }
...
export class PersonListDtoListResultDto implements IPersonListDtoListResultDto {
    items: PersonListDto[] | undefined;

    constructor(data?: IPersonListDtoListResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PersonListDtoListResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new PersonListDtoListResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): PersonListDtoListResultDto {
        const json = this.toJSON();
        let result = new PersonListDtoListResultDto();
        result.init(json);
        return result;
...
export interface IPersonListDtoListResultDto {
    items: PersonListDto[] | undefined;
}
